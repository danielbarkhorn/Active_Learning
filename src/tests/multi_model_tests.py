...
for sampleSize in range(50, 600, 10):
    ...
    for _ in range(150):
        ...
        for stepSize in [5,10,15]:
            ...
            activeSVMF1s[stepSize] = active_SVM.test_metric(test_pca.get_x(), test_pca.get_y(), f1=True, avg='weighted')
            ...
            activeRFF1s[stepSize] = active_RF.test_metric(test_pca.get_x(), test_pca.get_y(), f1=True, avg='weighted')

    pickle.dump(randSVMF1s, open(rSVMfname, "wb" ))
    pickle.dump(activeSVMF1s, open(aSVMfname, "wb" ))

    pickle.dump(randRFF1s, open(rRFfname, "wb" ))
    pickle.dump(activeRFF1s, open(aRFfname, "wb" ))
