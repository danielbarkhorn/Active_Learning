...
for sampleSize in range(50, 211, 10):
    ...
    #plt.scatter(X, svmSysF1[sampleSize], s=8, c='Green', alpha=0.075)
...
#plt.plot(range(50, 211, 10), sys_means,linewidth=3.0, c='Green',alpha=0.5)
...
plt.title('RF F1 Scores: Active vs Random')
